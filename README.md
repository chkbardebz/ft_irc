...
PART <channel_name> [<part_message>] // Removes the client from the channel and sends a message (optional) to
all the clients that are in that channel, if the client that quits the channel is the last client in it, the
